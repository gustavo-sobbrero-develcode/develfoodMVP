...
import {Image, Keyboard, StatusBar, TouchableWithoutFeedback} from 'react-native';
      ...
      <Container>
        ...
        onPress={() => navigation.navigate('Login' as never)} />
          <Content>
            ...
            <Description>
            Sua senha foi redefinida com sucesso! Agora você pode aproveitar todos os serviços Develfood! 
            </Description>
